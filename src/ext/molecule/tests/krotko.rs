/// Test on examples from paper: Atomic ring invariant and Modified CANON extended connectivity algorithm for symmetry perception in molecular graphs and rigorous canonicalization of SMILES 
///

#[cfg(test)]
mod test_krotko_paper {
    use crate::core;
